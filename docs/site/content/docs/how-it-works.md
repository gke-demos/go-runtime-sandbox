...
weight: 30
description: "Design and rationale: the three execution layers, the multi-file upload mechanism, lifecycle decisions, gotchas from real-world testing."
---


Derived from [`spec.md`](https://github.com/gke-demos/go-runtime-sandbox/blob/main/docs/spec.md). The spec answers *what*; this document
answers *how*.
